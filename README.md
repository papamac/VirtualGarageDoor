...
The plugin can monitor a wide variety of optional devices to track the door
state. The tracking accuracy will depend upon the selected devices and the
door's operational cycle. In general, accurate tracking through all operational
cycles will require more devices. Tracking performance is discussed in detail
later in Section 5.
